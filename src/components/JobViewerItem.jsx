...
export default class JobViewerItem extends React.Component {
    render(){
        return (
            <Link to="/"className={"job-viewer__item " + (this.props.active ? "job-viewer__item--active" : "")}>
                <img className="job-viewer__item__img" src={this.props.img} alt={this.props.employer} />
                <span class="job-viewer__item__content">
